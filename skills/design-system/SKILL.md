---
name: design-system
description: Apply an existing product design system during UI implementation by reusing tokens, primitives, components, patterns, and documented rules instead of inventing duplicates or arbitrary values. Use when a repository already has a design system or DESIGN.md.
---
...
- There is no existing system to apply; follow the task brief and project instructions instead.
